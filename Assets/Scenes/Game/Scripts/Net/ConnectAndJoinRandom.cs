...
namespace Net
{
	public class ConnectAndJoinRandom : Photon.MonoBehaviour
	{
		...
		public bool WaitForOtherPlayer = true;
		...
		public void OnJoinedRoom()
		{
			...
			StartCoroutine(WaitForSecondPlayerToJoin_Routine());
		}

		private IEnumerator WaitForSecondPlayerToJoin_Routine()
		{
			if(WaitForOtherPlayer)
			{
				...
				// Each client calls start game!
				Game.GameController.Instance.StartGame();
			}
		}
